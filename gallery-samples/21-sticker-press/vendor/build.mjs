...
//    about rendering safety either: svg2pdf has no default colour of its
//    own. An unresolved `currentColor` (or an unsubstituted PLACEHOLDER_STROKE)
//    makes it emit no colour operator at all, so the shape silently inherits
//    whatever colour was already active in the ambient graphics state —
//    black on a fresh page, but the colour of whatever was drawn just before
//    it otherwise. Not invisible and not a filled blob, but not a "default"
//    either — verified directly by preceding an unresolved icon with a
//    green stroke and a blue one and watching it track each. It has to be
//    resolved because nothing else will pick the *intended* colour, not
//    because leaving it in would break the render outright.
//
...
// --- Curated wanted list -----------------------------------------------------
//
// Task B's curated registry: every entry in registry.json — the hand-drawn
// "furniture" band from the original design (tabs, banners, bookmarks,
// pennants, rosettes, tape) was cut entirely after a human design review;
// every one of the 500 stickers is sourced artwork now. 330 Lucide ids +
// 170 Twemoji codepoints, grouped by the category they serve so this list
// reads the same way the registry does. Regenerated from
...
const WANTED = [
    ...
    { id: 'lucide-circle-x', source: 'lucide', upstream: 'circle-x' },
    ...
    { id: 'twemoji-night-with-stars', source: 'twemoji', upstream: '1f303' },
    ...
    // Travel & places (31)
    { id: 'lucide-truck', source: 'lucide', upstream: 'truck' },
    { id: 'lucide-car', source: 'lucide', upstream: 'car' },
    { id: 'lucide-pyramid', source: 'lucide', upstream: 'pyramid' },
    { id: 'lucide-bus', source: 'lucide', upstream: 'bus' },
    { id: 'lucide-circle-parking', source: 'lucide', upstream: 'circle-parking' },
    ...
    { id: 'lucide-fuel', source: 'lucide', upstream: 'fuel' },
    { id: 'lucide-anchor', source: 'lucide', upstream: 'anchor' },
    { id: 'lucide-tower-control', source: 'lucide', upstream: 'tower-control' },
    { id: 'lucide-cable-car', source: 'lucide', upstream: 'cable-car' },
    ...
    { id: 'twemoji-torii-gate', source: 'twemoji', upstream: '26e9' },
    { id: 'twemoji-auto-rickshaw', source: 'twemoji', upstream: '1f6fa' },
    { id: 'twemoji-statue-of-liberty', source: 'twemoji', upstream: '1f5fd' },
